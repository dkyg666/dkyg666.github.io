import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as e,e as i}from"./app-DFk01ace.js";const l={};function d(c,n){return a(),e("div",null,n[0]||(n[0]=[i(`<h1 id="多阶段构建" tabindex="-1"><a class="header-anchor" href="#多阶段构建"><span>多阶段构建</span></a></h1><h2 id="之前的做法" tabindex="-1"><a class="header-anchor" href="#之前的做法"><span>之前的做法</span></a></h2><p>在 Docker 17.05 版本之前，我们构建 Docker 镜像时，通常会采用两种方式：</p><h3 id="全部放入一个-dockerfile" tabindex="-1"><a class="header-anchor" href="#全部放入一个-dockerfile"><span>全部放入一个 Dockerfile</span></a></h3><p>一种方式是将所有的构建过程编包含在一个 <code>Dockerfile</code> 中，包括项目及其依赖库的编译、测试、打包等流程，这里可能会带来的一些问题：</p><ul><li><p>镜像层次多，镜像体积较大，部署时间变长</p></li><li><p>源代码存在泄露的风险</p></li></ul><p>例如，编写 <code>app.go</code> 文件，该程序输出 <code>Hello World!</code></p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main
