...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="nginx-ssl配置" tabindex="-1"><a class="header-anchor" href="#nginx-ssl配置"><span>Nginx ssl配置</span></a></h2><details><summary>【查看详情】</summary><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
server {
    listen 80;
    listen [::]:80;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="reference" tabindex="-1"><a class="header-anchor" href="#reference"><span>Reference</span></a></h1>`,28)),s("ul",null,[s("li",null,[s("a",v,[n[3]||(n[3]=e("docker国内镜像源配置及走代理设置_docker 镜像代理-CSDN博客")),i(a)])])]),n[7]||(n[7]=l(`<h1 id="说明" tabindex="-1"><a class="header-anchor" href="#说明"><span>说明</span></a></h1><ul><li><p>首先，自己要解决网络问题，这里省略一万字...</p></li><li><p>注意：配置了<code>daemon.json</code>的，去把里面的镜像源都先删掉，可以先备份一下。</p></li></ul><h1 id="命令" tabindex="-1"><a class="header-anchor" href="#命令"><span>命令</span></a></h1><ul><li>在docker的进程服务文件夹配置代理，如果没有我们就新建这个文件夹：</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">mkdir</span> /usr/lib/systemd/system/docker.service.d
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1)),s("p",null,[n[21]||(n[21]=e("当你看到 ")),n[22]||(n[22]=s("code",null,"start server@0.0.0.0:5244",-1)),n[23]||(n[23]=e(" 的输出，之后没有报错，说明操作成功。 第一次运行时会输出初始密码。程序默认监听 5244 端口。 现在打开 ")),n[24]||(n[24]=s("code",null,"http://ip:5244",-1)),n[25]||(n[25]=e(" 可以看到登录页面，WebDAV 请参阅 ")),s("a",_,[n[20]||(n[20]=e("WebDav")),i(a)]),n[26]||(n[26]=e("。"))]),s("h2",P,[s("a",T,[s("span",null,[s("a",w,[n[27]||(n[27]=e("#")),i(a)]),n[28]||(n[28]=s("strong",null,"手动运行",-1))])])]),n[93]||(n[93]=l(`<p>v3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><p>Linux</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 解压下载的文件，得到可执行文件：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，执行 <code>systemctl daemon-reload</code> 重载配置，现在你可以使用这些命令来管理程序：</p><ul><li>启动: <code>systemctl start alist</code></li><li>关闭: <code>systemctl stop alist</code></li><li>配置开机自启: <code>systemctl enable alist</code></li><li>取消开机自启: <code>systemctl disable alist</code></li><li>状态: <code>systemctl status alist</code></li><li>重启: <code>systemctl restart alist</code></li></ul>`,5)),s("p",null,[n[33]||(n[33]=e("守护进程不配置? ")),s("a",R,[n[31]||(n[31]=s("strong",null,"视频教程",-1)),n[32]||(n[32]=e("open in new window")),i(a)])]),n[95]||(n[95]=l(`<p>相关信息</p><p>对于所有平台，您可以使用以下命令来静默启动、停止和重新启动。 （v3.4.0 及更高版本）</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 携带\`--force-bin-dir\`参数启动服务</span>
alist start
<span class="token comment"># 通过pid停止服务</span>
alist stop
<span class="token comment"># 通过pid重启服务</span>
alist restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3)),s("h2",S,[s("a",U,[s("span",null,[s("a",B,[n[34]||(n[34]=e("#")),i(a)]),n[35]||(n[35]=s("strong",null,"如何更新",-1))])])]),n[96]||(n[96]=s("p",null,"下载新版Alist，把之前的替换了即可。",-1)),n[97]||(n[97]=s("ul",null,[s("li",null,[e("启动: "),s("code",null,"systemctl start alist")]),s("li",null,[e("关闭: "),s("code",null,"systemctl stop alist")]),s("li",null,[e("状态: "),s("code",null,"systemctl status alist")]),s("li",null,[e("重启: "),s("code",null,"systemctl restart alist")])],-1)),s("h2",N,[s("a",O,[s("span",null,[s("a",q,[n[36]||(n[36]=e("#")),i(a)]),n[37]||(n[37]=s("strong",null,"获取密码",-1))])])]),n[98]||(n[98]=s("p",null,"需要进入脚本安装AList的目录文件夹內执行如下命令",-1)),s("h4",j,[s("a",F,[s("span",null,[s("a",z,[n[38]||(n[38]=e("#")),i(a)]),n[39]||(n[39]=e("低于v3.25.0版本"))])])]),n[99]||(n[99]=s("div",{class:"language-bash line-numbers-mode","data-ext":"sh","data-title":"sh"},[s("pre",{class:"language-bash"},[s("code",null,`./alist admin
`)]),s("div",{class:"line-numbers","aria-hidden":"true"},[s("div",{class:"line-number"})])],-1)),s("h4",$,[s("a",L,[s("span",null,[s("a",W,[n[40]||(n[40]=e("#")),i(a)]),n[41]||(n[41]=e("高于v3.25.0版本"))])])]),n[100]||(n[100]=l(`<p>3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 随机生成一个密码</span>
./alist admin random
<span class="token comment"># 手动设置一个密码,\`NEW_PASSWORD\`是指你需要设置的密码</span>
./alist admin <span class="token builtin class-name">set</span> NEW_PASSWORD
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5)),s("h4",M,[s("a",G,[s("span",null,[s("a",H,[n[42]||(n[42]=e("#")),i(a)]),n[43]||(n[43]=s("strong",null,"高于v3.25.0版本",-1))])])]),n[101]||(n[101]=l(`<p>3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 随机生成一个密码</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,8)),s("h3",gn,[s("a",kn,[s("span",null,[s("a",hn,[n[61]||(n[61]=e("#")),i(a)]),n[62]||(n[62]=s("strong",null,"手动编译 Docker 镜像",-1))])])]),n[107]||(n[107]=l(`<p>安装 docker，克隆仓库后进入仓库根目录，无需其他准备</p><p>basic</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> build <span class="token parameter variable">-t</span> xhofe/alist:latest <span class="token builtin class-name">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="从源码运行" tabindex="-1"><a class="header-anchor" href="#从源码运行"><span>从源码运行</span></a></h1><h2 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备"><span><strong>环境准备</strong></span></a></h2><p>首先，你需要一个有<code>git</code>，<code>nodejs</code>，<code>pnpm</code>，<code>golang&gt;=1.20</code>，<code>gcc</code>的环境</p>`,16)),s("h2",xn,[s("a",fn,[s("span",null,[s("a",En,[n[63]||(n[63]=e("#")),i(a)]),n[64]||(n[64]=s("strong",null,"构建前端",-1))])])]),n[108]||(n[108]=s("p",null,[e("使用 "),s("code",null,"git clone --recurse-submodules https://github.com/alist-org/alist-web.git"),e(" 克隆前端 ，执行 "),s("code",null,"pnpm install && pnpm build"),e(" 得到 dist 目录下的目标文件")],-1)),s("h2",yn,[s("a",An,[s("span",null,[s("a",_n,[n[65]||(n[65]=e("#")),i(a)]),n[66]||(n[66]=s("strong",null,"构建后端",-1))])])]),s("p",null,[n[68]||(n[68]=e("克隆 ")),s("a",Pn,[n[67]||(n[67]=e("https://github.com/alist-org/alistopen in new window")),i(a)]),n[69]||(n[69]=e(" ，将上一步的 ")),n[70]||(n[70]=s("code",null,"dist",-1)),n[71]||(n[71]=e(" 目录复制到项目下的 ")),n[72]||(n[72]=s("code",null,"public",-1)),n[73]||(n[73]=e(" 目录下，然后执行："))]),n[109]||(n[109]=l(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token assign-left variable">appName</span><span class="token operator">=</span><span class="token string">&quot;alist&quot;</span>
