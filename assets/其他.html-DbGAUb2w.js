...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1)),s("p",null,[n[21]||(n[21]=e("当你看到 ")),n[22]||(n[22]=s("code",null,"start server@0.0.0.0:5244",-1)),n[23]||(n[23]=e(" 的输出，之后没有报错，说明操作成功。 第一次运行时会输出初始密码。程序默认监听 5244 端口。 现在打开 ")),n[24]||(n[24]=s("code",null,"http://ip:5244",-1)),n[25]||(n[25]=e(" 可以看到登录页面，WebDAV 请参阅 ")),s("a",P,[n[20]||(n[20]=e("WebDav")),i(a)]),n[26]||(n[26]=e("。"))]),s("h2",T,[s("a",w,[s("span",null,[s("a",_,[n[27]||(n[27]=e("#")),i(a)]),n[28]||(n[28]=s("strong",null,"手动运行",-1))])])]),n[93]||(n[93]=l(`<p>v3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><p>Linux</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 解压下载的文件，得到可执行文件：</span>
...
alist restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3)),s("h2",U,[s("a",B,[s("span",null,[s("a",N,[n[34]||(n[34]=e("#")),i(a)]),n[35]||(n[35]=s("strong",null,"如何更新",-1))])])]),n[96]||(n[96]=s("p",null,"下载新版Alist，把之前的替换了即可。",-1)),n[97]||(n[97]=s("ul",null,[s("li",null,[e("启动: "),s("code",null,"systemctl start alist")]),s("li",null,[e("关闭: "),s("code",null,"systemctl stop alist")]),s("li",null,[e("状态: "),s("code",null,"systemctl status alist")]),s("li",null,[e("重启: "),s("code",null,"systemctl restart alist")])],-1)),s("h2",S,[s("a",O,[s("span",null,[s("a",q,[n[36]||(n[36]=e("#")),i(a)]),n[37]||(n[37]=s("strong",null,"获取密码",-1))])])]),n[98]||(n[98]=s("p",null,"需要进入脚本安装AList的目录文件夹內执行如下命令",-1)),s("h4",j,[s("a",F,[s("span",null,[s("a",z,[n[38]||(n[38]=e("#")),i(a)]),n[39]||(n[39]=e("低于v3.25.0版本"))])])]),n[99]||(n[99]=s("div",{class:"language-bash line-numbers-mode","data-ext":"sh","data-title":"sh"},[s("pre",{class:"language-bash"},[s("code",null,`./alist admin
`)]),s("div",{class:"line-numbers","aria-hidden":"true"},[s("div",{class:"line-number"})])],-1)),s("h4",L,[s("a",$,[s("span",null,[s("a",W,[n[40]||(n[40]=e("#")),i(a)]),n[41]||(n[41]=e("高于v3.25.0版本"))])])]),n[100]||(n[100]=l(`<p>3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 随机生成一个密码</span>
./alist admin random
<span class="token comment"># 手动设置一个密码,\`NEW_PASSWORD\`是指你需要设置的密码</span>
./alist admin <span class="token builtin class-name">set</span> NEW_PASSWORD
