import{_ as r}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,e as n,b as i,d as t,a as o,o as a,r as l}from"./app-BA4_Sfsq.js";const c={},v={href:"http://192.168.18.2",target:"_blank",rel:"noopener noreferrer"};function p(u,e){const d=l("ExternalLinkIcon");return a(),s("div",null,[e[2]||(e[2]=n(`<h1 id="根据esir固件制作openwrt-docker镜像" tabindex="-1"><a class="header-anchor" href="#根据esir固件制作openwrt-docker镜像"><span>根据esir固件制作openwrt docker镜像</span></a></h1><p>1.下载固件包</p><p>然后把下好的openwrt固件包丢到linux虚拟机里.</p><p>2.制作docker openwrt镜像包</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[root@localhost ~]# mkdir openwrt
