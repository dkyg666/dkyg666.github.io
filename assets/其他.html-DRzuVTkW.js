...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，执行 <code>systemctl daemon-reload</code> 重载配置，现在你可以使用这些命令来管理程序：</p><ul><li>启动: <code>systemctl start alist</code></li><li>关闭: <code>systemctl stop alist</code></li><li>配置开机自启: <code>systemctl enable alist</code></li><li>取消开机自启: <code>systemctl disable alist</code></li><li>状态: <code>systemctl status alist</code></li><li>重启: <code>systemctl restart alist</code></li></ul>`,5)),s("p",null,[n[33]||(n[33]=e("守护进程不配置? ")),s("a",U,[n[31]||(n[31]=s("strong",null,"视频教程",-1)),n[32]||(n[32]=e("open in new window")),i(a)])]),n[95]||(n[95]=l(`<p>相关信息</p><p>对于所有平台，您可以使用以下命令来静默启动、停止和重新启动。 （v3.4.0 及更高版本）</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 携带\`--force-bin-dir\`参数启动服务</span>
alist start
<span class="token comment"># 通过pid停止服务</span>
alist stop
<span class="token comment"># 通过pid重启服务</span>
alist restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3)),s("h2",D,[s("a",R,[s("span",null,[s("a",N,[n[34]||(n[34]=e("#")),i(a)]),n[35]||(n[35]=s("strong",null,"如何更新",-1))])])]),n[96]||(n[96]=s("p",null,"下载新版Alist，把之前的替换了即可。",-1)),n[97]||(n[97]=s("ul",null,[s("li",null,[e("启动: "),s("code",null,"systemctl start alist")]),s("li",null,[e("关闭: "),s("code",null,"systemctl stop alist")]),s("li",null,[e("状态: "),s("code",null,"systemctl status alist")]),s("li",null,[e("重启: "),s("code",null,"systemctl restart alist")])],-1)),s("h2",O,[s("a",S,[s("span",null,[s("a",q,[n[36]||(n[36]=e("#")),i(a)]),n[37]||(n[37]=s("strong",null,"获取密码",-1))])])]),n[98]||(n[98]=s("p",null,"需要进入脚本安装AList的目录文件夹內执行如下命令",-1)),s("h4",j,[s("a",F,[s("span",null,[s("a",z,[n[38]||(n[38]=e("#")),i(a)]),n[39]||(n[39]=e("低于v3.25.0版本"))])])]),n[99]||(n[99]=s("div",{class:"language-bash line-numbers-mode","data-ext":"sh","data-title":"sh"},[s("pre",{class:"language-bash"},[s("code",null,`./alist admin
