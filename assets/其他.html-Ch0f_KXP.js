...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="通过公钥进行ssh连接" tabindex="-1"><a class="header-anchor" href="#通过公钥进行ssh连接"><span>通过公钥进行ssh连接</span></a></h2><details><summary>【查看详情】</summary><h1 id="通过公钥进行ssh连接-1" tabindex="-1"><a class="header-anchor" href="#通过公钥进行ssh连接-1"><span>通过公钥进行ssh连接</span></a></h1><p>这篇文章介绍了使用ssh公钥连接设备的方法</p><p>注意</p><p>注1、建议使用1.2法二在本地生成密钥。</p><h2 id="_1-生成密钥" tabindex="-1"><a class="header-anchor" href="#_1-生成密钥"><span>1 生成密钥</span></a></h2><h3 id="_1-1-法一-在设备生成密钥-不推荐" tabindex="-1"><a class="header-anchor" href="#_1-1-法一-在设备生成密钥-不推荐"><span>1.1 法一：在设备生成密钥[<strong>不推荐</strong>]</span></a></h3><p>我们先正常的ssh连接到设备，输入如下命令，然后一直回车，生成密钥。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>ssh-keygen -m PEM -t rsa -b 4096 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1)),e("p",null,[n[21]||(n[21]=s("当你看到 ")),n[22]||(n[22]=e("code",null,"start server@0.0.0.0:5244",-1)),n[23]||(n[23]=s(" 的输出，之后没有报错，说明操作成功。 第一次运行时会输出初始密码。程序默认监听 5244 端口。 现在打开 ")),n[24]||(n[24]=e("code",null,"http://ip:5244",-1)),n[25]||(n[25]=s(" 可以看到登录页面，WebDAV 请参阅 ")),e("a",_,[n[20]||(n[20]=s("WebDav")),i(a)]),n[26]||(n[26]=s("。"))]),e("h2",P,[e("a",T,[e("span",null,[e("a",w,[n[27]||(n[27]=s("#")),i(a)]),n[28]||(n[28]=e("strong",null,"手动运行",-1))])])]),n[93]||(n[93]=l(`<p>v3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><p>Linux</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 解压下载的文件，得到可执行文件：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，执行 <code>systemctl daemon-reload</code> 重载配置，现在你可以使用这些命令来管理程序：</p><ul><li>启动: <code>systemctl start alist</code></li><li>关闭: <code>systemctl stop alist</code></li><li>配置开机自启: <code>systemctl enable alist</code></li><li>取消开机自启: <code>systemctl disable alist</code></li><li>状态: <code>systemctl status alist</code></li><li>重启: <code>systemctl restart alist</code></li></ul>`,5)),e("p",null,[n[33]||(n[33]=s("守护进程不配置? ")),e("a",R,[n[31]||(n[31]=e("strong",null,"视频教程",-1)),n[32]||(n[32]=s("open in new window")),i(a)])]),n[95]||(n[95]=l(`<p>相关信息</p><p>对于所有平台，您可以使用以下命令来静默启动、停止和重新启动。 （v3.4.0 及更高版本）</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 携带\`--force-bin-dir\`参数启动服务</span>
alist start
<span class="token comment"># 通过pid停止服务</span>
alist stop
<span class="token comment"># 通过pid重启服务</span>
alist restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3)),e("h2",S,[e("a",U,[e("span",null,[e("a",B,[n[34]||(n[34]=s("#")),i(a)]),n[35]||(n[35]=e("strong",null,"如何更新",-1))])])]),n[96]||(n[96]=e("p",null,"下载新版Alist，把之前的替换了即可。",-1)),n[97]||(n[97]=e("ul",null,[e("li",null,[s("启动: "),e("code",null,"systemctl start alist")]),e("li",null,[s("关闭: "),e("code",null,"systemctl stop alist")]),e("li",null,[s("状态: "),e("code",null,"systemctl status alist")]),e("li",null,[s("重启: "),e("code",null,"systemctl restart alist")])],-1)),e("h2",N,[e("a",O,[e("span",null,[e("a",q,[n[36]||(n[36]=s("#")),i(a)]),n[37]||(n[37]=e("strong",null,"获取密码",-1))])])]),n[98]||(n[98]=e("p",null,"需要进入脚本安装AList的目录文件夹內执行如下命令",-1)),e("h4",j,[e("a",z,[e("span",null,[e("a",F,[n[38]||(n[38]=s("#")),i(a)]),n[39]||(n[39]=s("低于v3.25.0版本"))])])]),n[99]||(n[99]=e("div",{class:"language-bash line-numbers-mode","data-ext":"sh","data-title":"sh"},[e("pre",{class:"language-bash"},[e("code",null,`./alist admin
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1)),e("h4",$,[e("a",L,[e("span",null,[e("a",W,[n[40]||(n[40]=s("#")),i(a)]),n[41]||(n[41]=s("高于v3.25.0版本"))])])]),n[100]||(n[100]=l(`<p>3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 随机生成一个密码</span>
./alist admin random
<span class="token comment"># 手动设置一个密码,\`NEW_PASSWORD\`是指你需要设置的密码</span>
./alist admin <span class="token builtin class-name">set</span> NEW_PASSWORD
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1)),e("h3",Cn,[e("a",In,[e("span",null,[n[86]||(n[86]=s("自动渐变背景")),e("a",Dn,[i(a)])])])]),n[111]||(n[111]=l(`<div class="language-html line-numbers-mode" data-ext="html" data-title="html"><pre class="language-html"><code><span class="token comment">&lt;!--放在自定义头部--&gt;</span>
