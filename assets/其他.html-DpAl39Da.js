...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1)),s("p",null,[n[21]||(n[21]=e("当你看到 ")),n[22]||(n[22]=s("code",null,"start server@0.0.0.0:5244",-1)),n[23]||(n[23]=e(" 的输出，之后没有报错，说明操作成功。 第一次运行时会输出初始密码。程序默认监听 5244 端口。 现在打开 ")),n[24]||(n[24]=s("code",null,"http://ip:5244",-1)),n[25]||(n[25]=e(" 可以看到登录页面，WebDAV 请参阅 ")),s("a",P,[n[20]||(n[20]=e("WebDav")),i(a)]),n[26]||(n[26]=e("。"))]),s("h2",w,[s("a",T,[s("span",null,[s("a",_,[n[27]||(n[27]=e("#")),i(a)]),n[28]||(n[28]=s("strong",null,"手动运行",-1))])])]),n[93]||(n[93]=l(`<p>v3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><p>Linux</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 解压下载的文件，得到可执行文件：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5)),s("h4",M,[s("a",G,[s("span",null,[s("a",X,[n[42]||(n[42]=e("#")),i(a)]),n[43]||(n[43]=s("strong",null,"高于v3.25.0版本",-1))])])]),n[101]||(n[101]=l(`<p>3.25.0以上版本将密码改成加密方式存储的hash值，无法直接反算出密码，如果忘记了密码只能通过重新 <strong><code>随机生成</code></strong> 或者 <strong><code>手动设置</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 随机生成一个密码</span>
